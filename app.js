...
window.addEventListener("keyup", () => {
    ...
    switch (event.key) {
        case "ArrowLeft":
            ...
            console.log(document.querySelector('#group').getBoundingClientRect().left + " " + document.querySelector('#group').getBoundingClientRect().top);
            break;
        case "ArrowRight":
            target.style.left = parseInt(target.style.left) + moveby + "px";
            console.log(document.querySelector('#group').getBoundingClientRect().left + " " + document.querySelector('#group').getBoundingClientRect().top);
...
function dragging(event) {
    ...
    let a = document.querySelector('#group').getBoundingClientRect();
    console.log(document.querySelector('#group').getBoundingClientRect().left + " " + document.querySelector('#group').getBoundingClientRect().top);
}
